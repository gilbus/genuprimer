...
def main():
    ...
    # config will not be read, therefore we can make no assumption whether
    # the primers are in the right region or not, since it could be custom
    # ones not generated by us
    seq_included_region = (0, 0)
